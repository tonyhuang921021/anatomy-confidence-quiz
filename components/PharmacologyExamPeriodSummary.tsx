...
export function PharmacologyExamPeriodSummary({
  ...
  return (
    <span className={`flex flex-wrap items-center gap-1.5 ${className}`} aria-label={`考過 ${periods.join("、")}`}>
      {showLabel ? <span className="mr-0.5 text-[11px] font-bold text-slate-500">考過</span> : null}
