...
const HOME_RELEASE_NOTES = [
  {
    time: "09/02",
    title: "115-2 申覆結果已進題庫",
    body: "醫學一、二共 8 題已照考選部更正判分；複數答案都算對，一律給分題也不再冤枉人。"
  },
  {
    time: "09/01",
    title: "藥理考點和考期排整齊了",
    body: "藥名、國考考點與考過時間現在一眼可比；點考期就能在站內看題，答案不會先爆雷。"
  },
  {
    time: "09/01",
    title: "藥卡想看哪科就看哪科",
    body: "藥理複習多了單一範圍選單；想專看腸胃、心臟或感染就直接切，沒有多一頁設定，也會記住上次選擇。"
  },
  {
    time: "08/30",
    title: "更多不再躲在卡片後面",
    body: "作答、結果與複習裡的「更多」現在會完整展開；手機上的浮動按鈕也會避開底部導覽，不再被蓋住。"
  },
  {
    time: "08/29",
    title: "自由做題設定不再兩邊找",
    body: "一般刷題預設先出沒做過的題目；年份、題數與作答方式收進開始前的設定，想調整再展開，也會記住上次選擇。"
  },
  {
    time: "08/29",
    title: "找題後直接開刷",
  ...
  },
  {
    time: "08/26",
    title: "章節練習與手機設定各就各位",
    body: "章節練習會先進設定頁再開刷；右上角與「更多」開啟同一個設定視窗，通知鈴鐺、手機推播與主畫面圖解都在裡面。"
  },
  {
    time: "08/25",
    title: "留言不再被回覆擠掉",
    body: "留言板一次先看 10 串，往下還能繼續載入，舊回覆也會完整跟著；手機推播開啟後，新留言不用守著網站也收得到。"
  },
  {
    time: "08/24",
    title: "答對率、章節練習與留言再整理",
    body: "正式題答完會清楚標出答對或答錯與全站答對率；進度頁章節可以直接練習，留言板也收整成更好閱讀的版面。"
  },
  {
    time: "08/21",
    title: "全站排版收整",
