...
const HOME_RELEASE_NOTES = [
  {
    time: "07/20",
    title: "115 年第二次考古題到站",
    body: "醫學一、醫學二共 200 題與官方答案已收進題庫，先刷起來；詳解之後再慢慢補齊。"
  },
  {
    time: "07/16",
    title: "剛做錯的題先喘口氣",
    body: "待複習題會先帶較久沒碰的內容；AI 模擬題也不再假裝成 2026 考古題。"
  },
  {
    time: "07/16",
    title: "刷題詳解也能牽類似題",
    body: "平常刷題答完後也能直接試做相同觀念類似題；不會算進正式作答紀錄，看到想留的題目可以直接儲存。"
  },
  {
    time: "07/16",
    title: "題目格式與陽明截圖再整理",
    body: "化學式、代號和上下標顯示已修正；另一批陽明詳解改用逐頁原始截圖，跨頁補充也一起保留。"
  },
  {
    time: "07/15",
    title: "待複習題可以挑年份",
    body: "散題和模擬考待複習都能選年份；剛複習過的題目會往後排，同時間附近的題目也會交錯科目。"
  },
  {
    time: "07/15",
    title: "考前兩天，一起穩住",
  ...
  {
    time: "07/14",
    title: "第二份 gpt5.6 醫學一模擬卷上線",
    body: "新增 100 題改良卷，作答後會標示難度與細節題；選卷時可看有效完成份數，完成該卷後再看全站平均與成績級距。"
  },
  {
    time: "07/14",
    title: "繼續作答不會再跳成隨機刷題",
    body: "從進行中測驗按繼續時，現在會鎖定原本那份題組與進度；若瀏覽器暫存失敗，也會留在原頁提醒，不會另開一份測驗。"
  },
  {
    time: "07/14",
    title: "AI 模擬題更會找類似題",
    body: "AI 題現在會用正確選項與核心考點找正式考古題；只放關聯夠明確的題目，不為了湊數亂配。"
  },
  {
    time: "07/14",
    title: "沒做過的題目可以先刷",
  ...
  {
    time: "07/13",
    title: "補回 106 年第一次第 92 題病理圖",
    body: "甲狀腺腫瘤的病理切片圖補回來了，現在題目和原始圖片會一起出現。"
  },
  {
    time: "07/13",
    title: "模擬考結果與續作補強",
    body: "模擬考結果改成只讀需要的考卷；續作不會再用較短明細蓋掉完整進度，還沒真正上雲的完成回合也會明確顯示待補傳。"
  },
  {
    time: "07/13",
    title: "搜題排序更好找",
    body: "題目搜尋新增答對率高低與「這題我們不要了」排行；多個關鍵字不用照原順序，篩選版面也更乾淨。"
  },
  {
    time: "07/13",
    title: "新增 gpt5.6 醫學二模擬卷",
    body: "AI 模擬考再加一份 100 題醫學（二）原創卷，從整份模擬考設定選「gpt5.6出的醫學二」就能開始。"
  },
  {
    time: "07/13",
    title: "題目字縫修好",
  ...
  },
  {
    time: "07/12",
    title: "類似題不只看同一標籤",
    body: "類似題會先看同考點，再用同科題幹與選項補找；舊題分類不同，只要文字證據夠強也能連回來。"
  },
  {
    time: "07/12",
    title: "結果回顧排得更順",
    body: "補強建議和信心度總覽改成整齊摘要；題目回顧上下鍵會依目前區塊順序切換，展開長詳解也不亂跳。"
  },
  {
    time: "07/12",
    title: "Safari 刷題少卡一下",
    body: "保留原本卡片和題目版面，改把大題庫整理、背景同步與結果頁分階段載入；切回視窗也不再重算沒有變動的紀錄。"
  },
  {
    time: "07/12",
    title: "進行中的測驗可以自己管理",
    body: "首頁會先列出尚未完成的考卷摘要，挑一份才讀完整紀錄，也能刪掉不要的進度；開始刷題不再等待背景同步。"
  },
  {
    time: "07/11",
    title: "自訂卷工作台重新整理",
  ...
  },
  {
    time: "07/11",
    title: "跨裝置補傳更耐斷線",
    body: "平板或電腦同步卡住時會先保住待補傳回合，登入過期會自動重試；較短的舊紀錄也不會蓋掉完整雲端紀錄。"
  },
  {
    time: "07/11",
    title: "抽題年份搬到開刷前",
    body: "開始測驗選完科目後，點題數摘要旁的年份範圍就能調整；總題數與未做題數會一起即時更新。"
  },
  {
    time: "07/11",
    title: "登入留言與完整同步補強",
    body: "已登入時留言預設會使用暱稱，不再因登入讀取較慢偷偷變匿名；完整雲端紀錄也會少繞很多趟，重度紀錄比較不容易卡在稍後補傳。"
  },
  {
    time: "07/11",
    title: "微免三科跟著新分類抽題",
    body: "散題選病毒、細菌或免疫時會直接依新考點標籤組題，真菌仍放在細菌這組，不再被題幹裡的其他關鍵字拉錯池。"
  },
  {
    time: "07/11",
    title: "各科進度可以拆開看",
    body: "進度總覽能展開每科的全部考點區塊，直接看完成度與答對率；點右側做題圖示也能立刻開刷。"
  },
  {
    time: "07/11",
    title: "陽明截圖續頁補回來",
