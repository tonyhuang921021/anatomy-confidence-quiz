...
export default function ReviewPage() {
  ...
  return (
    <main id="main-content" className="shell workspace-page">
      <section className="surface-card workspace-page-panel workspace-page-header p-5 sm:p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">散題錯題與低信心題，依複習狀態接續安排。</p>
          </div>
      ...
      <section className="saved-summary-strip mt-5" aria-label="待複習摘要">
        <article className="saved-summary-item">
          <p className="text-xs font-semibold text-slate-500">待複習</p>
          <p className="mt-1 text-xl font-semibold text-ink">{reviewCount} 題</p>
        </article>
        <article className="saved-summary-item">
          <p className="text-xs font-semibold text-slate-500">低信心</p>
          <p className="mt-1 text-xl font-semibold text-ink">{lowConfidenceCount} 題</p>
        </article>
      </section>
          ...
          <ReviewNotebook
            ...
            headerAction={
              <button
                ...
                className="inline-flex min-h-10 items-center justify-center rounded-lg bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-800 transition hover:bg-slate-200 sm:hidden"
                aria-label="開啟滿版待複習題"
                title="開啟滿版待複習題"
              >
                ⛶ 滿版模式
        ...
        >
          ...
          >
            <div className="flex items-center justify-between gap-3 border-b px-4 py-3 shadow-sm border-[color:var(--line-soft)] bg-[color:var(--surface)] backdrop-blur">
              <div>
                <p className="text-xs font-semibold text-brand-700">滿版複習</p>
